...
```{r Data, echo=TRUE, message=FALSE, warning=FALSE, include=TRUE, fig.height=8, fig.width=12}
...
```{r Rates, echo=TRUE, message=FALSE, warning=FALSE, include=TRUE, fig.height=8, fig.width=12}
invisible({
...
```{r ModelsHF, echo=TRUE, message=FALSE, warning=FALSE, include=TRUE, fig.height=8, fig.width=12}
...
```{r ModelsDeath, echo=TRUE, message=FALSE, warning=FALSE, include=TRUE, fig.height=8, fig.width=12}
...
t2b <- data.table(followup = rep(c("30 Days",
                                   "90 Days",
                                   "180 Days",
                                   "1 Year"),
                                 each = length(t2abc.names)),
...
```{r ModelsHForDeath, echo=TRUE, message=FALSE, warning=FALSE, include=TRUE, fig.height=8, fig.width=12}
# Publication/Table 2c: all-cause death or readmission for HF----
case$hf.dead30 <- case$hf.dead90 <- case$hf.dead180 <- case$hf.dead1y <- FALSE
...
t2c <- data.table(followup = rep(c("30 Days",
                                   "90 Days",
                                   "180 Days",
                                   "1 Year"),
                                 each = length(t2abc.names)),
